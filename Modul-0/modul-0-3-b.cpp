...
void slist_insertAt(SinglyList *list, char* index, char* value);
void slist_removeAt(SinglyList *list, char* index);
void slist_remove(SinglyList *list, char* value);
char*  slist_front(SinglyList *list);
char*  slist_back(SinglyList *list);
char*  slist_getAt(SinglyList *list, char* index);
...
int main(int argc, char const *argv[])
{
    ...
    char a[] = "satu", b[] = "dua", c[] = "tiga", d[] = "empat", 
	e[] = "lima", f[] = "enam", g[] = "tujuh", h[] = "delapan", i[] = "sembilan", j[] = "sepuluh";
    slist_pushBack(&myList, a);
    slist_pushBack(&myList, b);
    slist_pushBack(&myList, c);
    slist_pushBack(&myList, d);

    slist_pushFront(&myList, h);
    slist_pushFront(&myList, g);
    slist_pushFront(&myList, f);
    slist_pushFront(&myList, e);
    ...
    slist_insertAt(&myList, 1, i);
    slist_pushBack(&myList, j);
